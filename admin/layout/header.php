            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="<?= site_url(); ?>/admin/index" style="margin-top:-10px; margin-top:-10px; ">
                        ...
                        <a class="nav-link" href="<?= site_url(); ?>/admin/databarang" style="margin-top:-10px; ">
                            <div class="sb-nav-link-icon"><i class="bi bi-clipboard-data"></i></div>
                            Data Barang
                        </a>
                        <a class="nav-link" href="<?= site_url(); ?>/admin/user" style="margin-top:-10px; ">
                            <div class="sb-nav-link-icon"><i class="bi bi-people"></i></div>
                            User
                        </a>
                        <a class="nav-link" href="<?= site_url(); ?>/admin/supplier" style="margin-top:-10px; ">
                            <div class="sb-nav-link-icon"><i class="bi bi-card-checklist"></i></div>
                            Supplier
                        </a>

                        <div class="sb-sidenav-menu-heading">MANAGEMEN BARANG</div>
                        <a class="nav-link" href="<?= site_url(); ?>/admin/masuk" style="margin-top:-10px; ">
                            <div class="sb-nav-link-icon"><i class="bi bi-box-arrow-in-up-right"></i></div>
                            Item Masuk
                        </a>
                        <a class="nav-link" href="<?= site_url(); ?>/admin/keluar" style="margin-top:-10px; ">
