...
$query = "
    SELECT bm.*, mb.jenis_barang, mb.nama_barang, mb.maker, mb.satuan, s.nama_supplier 
    FROM barang_masuk bm
    JOIN master_barang mb ON bm.kode_barang = mb.kode_barang 
    JOIN supplier s ON bm.supplier_id = s.id
    WHERE bm.transaksi = '$transaksi'
";
...
<head>
    ...
    <script type="text/javascscriptcharset=" charset="utf8" src="../../js/jquery.dataTables.js"></script>
</head>
            ...
            <table class="table table-hover table-striped table-bordered " id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        echo "<tr><td colspan='9' class='text-center'>Tidak ada data untuk transaksi ini</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
